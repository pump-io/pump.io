...
User.beforeCreate = function(props, callback) {
    ...
    Step(
        ...
        function(err, hash) {
            ...
            props.passwordHash = hash;
            delete props.password;
            pprops = {"preferredUsername": props.nickname,
                      _user: true,
            ...
            if (URLMaker.port == 80) {
                ...
                pprops.links = {
                    ...
                    "activity-inbox": {
                        href: URLMaker.makeURL("api/user/" + props.nickname + "/inbox")
                    },
                    "activity-outbox": {
                        href: URLMaker.makeURL("api/user/" + props.nickname + "/feed")
                    }
                };
            }
