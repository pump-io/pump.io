...
var connect = function(app, log) {
    var slog = log.child({component: "sockjs"}),
        options = {
            sockjs_url: (URLMaker.path) ? "/" + URLMaker.path + "/javascript/sockjs.min.js" : "/javascript/sockjs.min.js",
            prefix: (URLMaker.path) ? "/" + URLMaker.path + "/main/realtime/sockjs" : "/main/realtime/sockjs",
