...
var connect = function(app, appServer, log) {
    ...
    cluster.worker.on("message", handleWorkerMessage);
    ...
    server.installHandlers(appServer, options);
};
