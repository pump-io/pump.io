        ...
        'and we register a client': {
            ...
            'and one user favorites another user\'s object': {
                topic: function(cl) {
                    ...
                    Step(
                        function() {
                            newPair("cindy", "pigtails", this.parallel());
                            newPair("bobby", "baseball", this.parallel());
                        },
            ...
            'and one user double-favorites another user\'s object': {
                topic: function(cl) {
                    ...
                    Step(
                        function() {
                            newPair("alice", "backpain", this.parallel());
                            newPair("sam", "alice", this.parallel());
                        },
            ...
            'and one user favorites then unfavorites another user\'s object': {
                topic: function(cl) {
                    ...
                    Step(
                        function() {
                            newPair("greg", "groovy", this.parallel());
                            newPair("peter", "vengeance", this.parallel());
                        },
            ...
            'and one user unfavorites another user\'s object they hadn\'t faved before': {
                topic: function(cl) {
                    ...
                    Step(
                        function() {
                            newPair("mike", "arch1tecture", this.parallel());
                            newPair("carol", "mike", this.parallel());
                        },
