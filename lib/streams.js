...
var objectFeed = function(types, relmaker, titlemaker, streammaker, finisher) {
...
var userFollowers = objectFeed(["person"],
                               function(user) {
...
var userFollowing = objectFeed(["person"],
                               function(user) {
...
var userFavorites = objectFeed(null,
                               function(user) {
                               ...
                               function(user, principal, collection, callback) {
                                   ...
                                   addLiked(collection.items, this.parallel());
...
var userUploads = objectFeed(["file", "image", "audio", "video"],
                             function(user) {
...
module.exports.userFavorites = userFavorites;
