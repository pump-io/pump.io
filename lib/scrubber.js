    ...
    scrub: function(str) {
        if (majorRelease < 4) {
            ...
            return sanitizeHtml(str, {
                allowedTags: sanitizeHtml.defaults.allowedTags.concat(["img", "style", "div", "span", "abbr", "address", "area", "aside", "audio", "b", "blockquote", "br", "caption", "cite", "source"]),
                allowedAttributes: {
                ...
                allowedSchemesByTag: ["http", "https", "ftp", "data"]
            });
        } else {
