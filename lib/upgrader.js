...
var Upgrader = new (function() {
    ...
    var upg = this,
        ...
        upgradePersonAvatar = function(person, callback) {
            ...
            if (person._user && _.isObject(person.image) && !_.has(person.image, "width") && _.isString(person.image.url)) {
                ...
                if (Upgrader.log) Upgrader.log.info({person: person.id}, "Upgrading person avatar");
        ...
        upgradeRemotePersonFeeds = function(person, callback) {
            ...
            if (Upgrader.log) Upgrader.log.info({person: person.id}, "Upgrading remote person feeds");
        ...
        upgradeUserFeeds = function(person, callback) {
            ...
            if (Upgrader.log) Upgrader.log.info({person: person.id}, "Upgrading user feeds");
    ...
    upg.upgradeImage = function(img, callback) {
        ...
        if (img._slug && _.isObject(img.image) && !_.has(img.image, "width")) {
            ...
            if (Upgrader.log) Upgrader.log.info({image: img.id}, "Upgrading image");
    ...
    upg.upgradeGroup = function(group, callback) {
        ...
        if (Upgrader.log) Upgrader.log.info({group: group.id}, "Upgrading group");
    ...
    upg.upgradeActivity = function(act, callback) {
        ...
        if (Upgrader.log) Upgrader.log.info({activity: act.id}, "Upgrading activity");
