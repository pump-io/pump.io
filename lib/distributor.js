...
var path = require("path"),
    ...
    tview = jade.compileFile(path.join(__dirname, "..", "public", "template", "lib", "activity-notification-text.pug")),
    hview = jade.compileFile(path.join(__dirname, "..", "public", "template", "lib", "activity-notification-html.pug"));
