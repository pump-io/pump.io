...
var path = require("path"),
    ...
    tview = jade.compileFile(path.join(__dirname, "..", "public", "template", "activity-notification-text.jade")),
    hview = jade.compileFile(path.join(__dirname, "..", "public", "template", "activity-notification-html.jade"));
