    ...
    "When we setup the app": {
        ...
        "and we HEAD the home page": {
            ...
            "the Content-Security-Policy header is correct": function(err, res, body) {
                ...
                assert.equal(res.headers["content-security-policy"], "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src *; object-src 'none'; media-src *; frame-ancestors 'none'; plugin-types 'none'");
            },
