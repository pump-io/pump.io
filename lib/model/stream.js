...
//
// Copyright 2011,2012,2013 StatusNet Inc.
//
            ...
            Step(
                ...
                function(err, parts) {
                    if (err) {
                        ...
                        callback(null, (parts.length === 1) ? parts[0] : parts[1].concat(parts[0]));
                    }
                }
            );
        };
...
Stream.prototype.indexOfLockless = function(id, callback) {
    var bank = Stream.bank(),
        ...
        indexOfSeg = function indexOfSeg(id, segments, offset, callback) {
            ...
            tip = segments[segments.length - 1];
            ...
            Step(
                ...
                function(err, idx) {
                    ...
                    if (err) {
                        ...
                        indexOfSeg(id, segments.slice(0, segments.length - 1), offset + cnt, callback);
                    } else {
                        rel = ((cnt - 1) - idx);
                        result = rel + offset;
