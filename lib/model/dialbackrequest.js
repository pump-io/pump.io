...
DialbackClientRequest.prototype.afterCreate = function(callback) {
    var req = this;

    Step(
        function() {
            DialbackClientRequest.stream(this);
        },
        function(err, str) {
            if (err) throw err;
...
DialbackClientRequest.cleanup = function(callback) {
    ...
    var cleanupFirst = function(str, callback) {
        ...
        maybeCleanup = function(id, callback) {
            Step(
                function() {
                    DialbackClientRequest.get(id, this);
                },
                function(err, req) {
...
DialbackClientRequest.stream = function(callback) {
...
setTimeout(function() {
    // XXX: log errors
    DialbackClientRequest.cleanup(function(err) {});
}, 60000);
