...
ActivityObject.validate = function(props) {
    ...
    if (_.has(props, "published")) {
        if (!_.isString(props.published)) {
            throw new TypeError("published property is not a string");
        }
    }

    // XXX: validate HTML

    if (_.has(props, "summary")) {
        if (!_.isString(props.summary)) {
            throw new TypeError("summary property is not a string");
        }
    }
