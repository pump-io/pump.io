...
Activity.prototype.applyAdd = function(callback) {
    ...
    var act = this,
	addToCollection = function(actor, object, target, callback) {
    ...
    Step(
		...
		addToCollection(act.actor, toAdd, target, this);
		break;
	    case ActivityObject.GROUP:
		addToGroup(act.actor, toAdd, target, this);
		break;
	    default:
...
Activity.prototype.ensureRecipients = function(callback) {
    ...
    if ((act.verb == Activity.DELETE || act.verb == Activity.UPDATE) &&
        ...
        act.to = [act.object];
        callback(null);
    } else if (act.object && act.object.objectType == ActivityObject.GROUP &&
               act.verb != Activity.CREATE &&
               (!act.actor || act.actor.id != act.object.id)) {
        // XXX: cc? bto?
        act.to = [act.object];
        callback(null);
    } else if (act.target && act.target.objectType == ActivityObject.GROUP &&
               (act.verb == Activity.ADD || act.verb == Activity.REMOVE)) {
        // XXX: cc? bto?
        act.to = [act.target];
        callback(null);
...
Activity.beforeCreate = function(props, callback) {
    ...
    Step(
        function() {
            ...
            ActivityObject.compressProperty(props, "generator", this.parallel());
...
Activity.prototype.beforeSave = function(callback) {
    ...
    Step(
        function() {
            ...
            ActivityObject.compressProperty(act, "generator", this.parallel());
...
Activity.prototype.expand = function(callback) {
    ...
    Step(
        function() {
            ...
            ActivityObject.expandProperty(act, "generator", this.parallel());
