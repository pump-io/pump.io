...
var path = require("path"),
    ...
    tview = pug.compileFile(path.join(__dirname, "..", "public", "template", "lib", "activity-notification-text.pug")),
    hview = pug.compileFile(path.join(__dirname, "..", "public", "template", "lib", "activity-notification-html.pug"));
