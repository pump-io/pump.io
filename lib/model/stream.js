...
Stream.prototype.getObjectsGreaterThan = function(id, count, callback) {
    var stream = this;
    Step(
        function() {
            stream.getItemsGreaterThan(id, count, this);
        },
        function(err, items) {
            var i, objs;
            if (err) {
...
Stream.prototype.getObjectsLessThan = function(id, count, callback) {
    var stream = this;
    Step(
        function() {
            stream.getItemsLessThan(id, count, this);
        },
        function(err, items) {
            var i, objs;
            if (err) {
