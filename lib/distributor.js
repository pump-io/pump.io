...
Distributor.prototype.distribute = function(callback) {
    var dtor = this,
        ...
        toFirehose = function(cb) {
            ...
            var recipients = dtor.activity.recipients(),
            ...
            Step(
                ...
                function(err, user) {
                    if (err) {
                        ...
                        Firehose.ping(dtor.activity, cb);
                    }
                }
            );
        };
...
Distributor.prototype.toList = function(list, callback) {
    ...
    var dtor = this,
        ...
        doMore = function(last, callback) {
            ...
            Step(
                function() {
                    if (last) {
                        str.getObjectsGreaterThan(last, Distributor.MAX_CHUNK, this);
                    } else {
                        str.getObjects(0, Distributor.MAX_CHUNK, this);
                    }
                },
                ...
                function(err) {
                    if (err) throw err;
                    if (members.length >= Distributor.MAX_CHUNK) {
