...
var Distributor = function(activity) {
    ...
    var dtor = this,
                ...
                Step(
                    ...
                    function(err, user) {
                        ...
                        if (user) {
                            ...
                            toRemotePerson(person, callback);
                        }
                    }
                );
            };
        ...
        toRemotePerson = function(person, callback) {
        ...
        notifyByEmail = function(user, activity, callback) {
            ...
            try {
                html = hview.fn({user: user, activity: activity});
                text = tview.fn({user: user, activity: activity});
            } catch (err) {
                callback(err, null);
                return;
            }
