...
var saveAvatar = function(user, mimeType, fileName, uploadDir, params, callback) {
    ...
    Step(
        ...
        function(err) {
            ...
            addAvatarMetadata(props, uploadDir, this);
        },
        function(err, props) {
            if (err) throw err;
            Cls.create(props, this);
...
var autorotate = function(oldName, newName, callback) {
    ...
    Step(
        function() {
            gm(oldName).autoOrient().write(newName, this);
        },
        function(err) {
            if (err) throw err;
