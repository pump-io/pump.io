...
testSchema =
  pkey: "id"
  fields: ["attachments", "author", "content", "displayName", "downstreamDuplicates", "id", "image", "objectType", "published", "summary", "updated", "upstreamDuplicates", "url", "uuid", "compression", "data", "fileUrl", "length", "md5", "mimeType"]
  indices: ["uuid"]
