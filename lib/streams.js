...
var databank = require("databank"),
    ...
    addIgnoreFinisher = finishers.addIgnoreFinisher;
    ...
    function(context, principal, collection, callback) {
        ...
        Step(
            function() {
                ...
                // Add the ignored flag for each object

                addIgnore(principal, collection.items, this.parallel());
    ...
    function(context, principal, collection, callback) {
        Step(
            function() {
                ...
                // Add the ignore flag for each object
...
exports.userPublicStream = userPublicStream;
