        ...
        app.configure(function() {
            ...
            app.use(helmet({
                contentSecurityPolicy: {
                    directives: {
                        "default-src": "'self'",
                        "script-src": ["'self'", "'unsafe-inline'", "'unsafe-eval'"].concat(config.noCDN ? [] : ["https://cdnjs.cloudflare.com", "https://ajax.googleapis.com"]),
                        "style-src": config.noCDN ? ["'self'"] : ["'self'", "https://cdnjs.cloudflare.com"],
                        "img-src": "*",
                        "object-src": ["'none'"],
                        "media-src": "*",
