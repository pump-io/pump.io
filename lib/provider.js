...
var Provider = function(logParent, clients) {
	...
	getClient = function(client_id, callback) {
		...
		if (client) {
		    // Older terms for these properties
		    client.consumer_key = client.client_id;
    ...
    prov.tokenByConsumer = function(consumerKey, callback) {
        ...
        getClient(consumerKey, function(err, client) {
            if (err) {
                callback(err, null);
            } else {
    ...
    prov.applicationByConsumerKey = function(consumerKey, callback) {
        ...
        getClient(consumerKey, callback);
    };
    ...
    prov.fetchAuthorizationInformation = function(username, token, callback) {
        ...
        RequestToken.get(token, function(err, rt) {
            if (err) {
                ...
                getClient(rt.consumer_key, function(err, client) {
                    if (err) {
                        callback(err, null, null);
                    } else {
    ...
    prov.userIdByToken = function(token, callback) {
        ...
        Step(
            ...
            function(err, res) {
                if (err) throw err;
                at = res;
                getClient(at.consumer_key, this);
            },
            function(err, res) {
                if (err) throw err;
                client = res;
    ...
    prov.generateRequestToken = function(oauthConsumerKey, oauthCallback, callback) {
        ...
        getClient(oauthConsumerKey, function(err, client) {
            if (err) {
                callback(err, null);
                return;
            }
    ...
    prov.newTokenPair = function(client, user, callback) {
        ...
        Step(
            ...
            function(err, rt) {
                if (err) throw err;
                prov.associateTokenToUser(user.nickname, rt.token, this);
            },
            function(err, rt) {
                if (err) throw err;
                prov.generateAccessToken(rt.token, this);
            },
            function(err, pair) {
                if (err) {
                    callback(err, null);
