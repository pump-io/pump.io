...
var PumpAPI = _.extend(_.clone(PumpApp), {
    ...
    initApp: function(app) {
        ...
        for (i = 0; i < Activity.objectTypes.length; i++) {
            ...
            app.put(url, this.mustAuth, this.requester(type), this.authorOnly(type), this.putter(type));
            app.del(url, this.mustAuth, this.requester(type), this.authorOnly(type), this.deleter(type));
        }
