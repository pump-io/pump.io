...
var ActivityPump = {
    ...
    initApp: function(app) {
        ...
        app.post('/user/:nickname/activities', ActivityPump.userAuth, ActivityPump.reqUser, ActivityPump.sameUser, ActivityPump.postActivity);
        app.get('/user/:nickname/activities', ActivityPump.reqUser, ActivityPump.userFeed); // XXX: privileged access when authenticated
