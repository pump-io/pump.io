...
var ActivityPump = {
    ...
    initApp: function(app) {
        ...
        ActivityPump.initApi(app);
        ActivityPump.initWeb(app);
    },
    ...
    initWeb: function(app) {
        ...
        app.get('/', pump.showMain);
        app.get('/home', pump.userAuth, pump.showInbox);
        app.get('/:nickname', pump.maybeAuth, pump.reqUser, pump.showStream);
        app.get('/:nickname/activity/:uuid', pump.maybeAuth, pump.reqUser, pump.requester('activity'), pump.showActivity);

        app.get('/login', pump.noUser, pump.showLogin);
        app.post('/login', pump.noUser, pump.handleLogin);

        app.post('/logout', pump.noUser, pump.handleLogin);
    },
